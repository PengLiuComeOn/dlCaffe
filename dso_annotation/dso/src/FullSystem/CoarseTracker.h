...
public:
    ...
    //（fwdWarpedIDDistFinal用于代表待激活点的一个阈值，范围0-40或1000，它用于在图像中均匀选点，1000代码该点未被选中）
...
private:
	...
	Eigen::Vector2i* bfsList1;   //记录滑动窗口里所有激活点重投影到最新帧上的坐标,以及扩展后的坐标
	Eigen::Vector2i* bfsList2;   //用于激活点扩张的一个备用数组
