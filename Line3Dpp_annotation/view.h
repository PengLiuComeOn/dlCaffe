...
namespace L3DPP
{
    ...
    public:
        ...
        double opticalAxesAngle(L3DPP::View* v);  // 该函数主要用于计算（在世界坐标系下）相机光心Po与图像中间位置Puv（cx, cy， 1） == pp_投影到3D空间Pw的连线所构成的向量
        ...
        {
            k_ = sigmaP/med_scene_depth; // k_ = 2.5 / -1
        }
    ...
    private:
        ...
        Eigen::Vector3d t_;
        Eigen::Vector3d C_; // optical center
        Eigen::Vector3d pp_;
        unsigned int width_;
